...
const UNLIMITED_MODELS = {
  creator: [
    { modelVariant: 'THEAIMODELAB_FAST', resolutions: ['RES_720P'] },
  ],
  pro: [
  ...
  advanced: [
    { modelVariant: 'THEAIMODELAB_FAST', resolutions: ['RES_720P'] },
    { modelVariant: 'THEAIMODELAB_QUALITY', resolutions: ['RES_720P'] },
...
// ── Links de checkout da ASSINATURA MENSAL recorrente na Perfect Pay ──
// Cada plano é uma assinatura recorrente própria. O front redireciona o usuário
// para esse link; a Perfect Pay cobra mensalmente e dispara o webhook a cada ciclo.
const CHECKOUT = {
...
async function main() {
  ...
  const packageData = [
    ...
    { name: 'Creator', update: { credits: 12000, priceCents: 8990, sortOrder: 0, isActive: false, checkoutUrl: null, perfectpayPlanCode: null }, create: { name: 'Creator', credits: 12000, priceCents: 8990, sortOrder: 0, isActive: false } },
    { name: 'Pro', update: { credits: 30000, priceCents: 17990, sortOrder: 1, isActive: false, checkoutUrl: null, perfectpayPlanCode: null }, create: { name: 'Pro', credits: 30000, priceCents: 17990, sortOrder: 1, isActive: false } },
    { name: 'Advanced', update: { credits: 50000, priceCents: 24990, sortOrder: 2, isActive: false, checkoutUrl: null, perfectpayPlanCode: null }, create: { name: 'Advanced', credits: 50000, priceCents: 24990, sortOrder: 2, isActive: false } },
    { name: 'Studio', update: { credits: 80000, priceCents: 36990, sortOrder: 3, isActive: false, checkoutUrl: null, perfectpayPlanCode: null }, create: { name: 'Studio', credits: 80000, priceCents: 36990, sortOrder: 3, isActive: false } },
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    const adminUser = await prisma.user.upsert({
      where: { email: 'admin@theaimodelab.com' },
      update: {},
      create: {
        email: 'admin@theaimodelab.com',
        name: 'Admin User',
